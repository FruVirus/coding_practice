...
pattern that is a suffix of what has been read so far in the text. Once the length of
the longest prefix of the pattern matches the length of the entire pattern itself and is
a suffix of what has been read so far in the text, then we have a match.
