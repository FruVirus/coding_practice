...
class Network:
    def __init__(self, sizes):
        ...
        and the third layer 1 neuron. The biases and weights for the network are
        ...
        won't set any biases for those neurons, since biases are only ever used in
    ...
    def evaluate(self, test_data):
        ...
        correct result. Note that the neural network's output is assumed to be the index
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        the desired outputs. The other non-optional parameters are self-explanatory. If
        ...
        n, n_test = len(training_data), len(test_data) if test_data else 0
