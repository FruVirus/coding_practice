...
upon partitioning the input array, thus improving the worst case selection time. Quick
select uses the deterministic partitioning algorithm from quicksort but modified to take
the element to partition around as an input parameter.
